...
vim.api.nvim_set_hl(0, "GlancePreviewCursorLine", { bg = theme.color1 })
...
vim.api.nvim_set_hl(0, "GlancePreviewLineNr", { bg = theme.color93 })
vim.api.nvim_set_hl(0, "GlancePreviewBorderBottom", { bg = theme.color93 })
vim.api.nvim_set_hl(0, "GlanceWinBarFilename", { bg = theme.color93 })
...
vim.api.nvim_set_hl(0, "GlanceListFilename", { bg = theme.color93 })
vim.api.nvim_set_hl(0, "GlanceListFilepath", { bg = theme.color93 })
vim.api.nvim_set_hl(0, "GlanceListCount", { bg = theme.color93 })
vim.api.nvim_set_hl(0, "GlanceListMatch", { bg = theme.color93 })
vim.api.nvim_set_hl(0, "GlanceListCursorLine", { bg = theme.color93 })
vim.api.nvim_set_hl(0, "GlanceListEndOfBuffer", { bg = theme.color93 })
vim.api.nvim_set_hl(0, "GlanceListBorderBottom", { bg = theme.color93 })
vim.api.nvim_set_hl(0, "GlanceFoldIcon", { bg = theme.color93 })
vim.api.nvim_set_hl(0, "GlanceIndent", { bg = theme.color93 })
vim.api.nvim_set_hl(0, "GlanceBorderTop", { bg = theme.color93 })
