...
M.rust_vim_event = { "BufRead *.rs", "BufReadPost" }

M.rust_vim_config = function()
  vim.g.rustfmt_autosave = 1
end

M.rust_tools_event = { "BufRead *.rs", "BufReadPre" }

M.rust_tools_dependencies = {
