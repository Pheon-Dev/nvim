...
local mappings = {
  ...
  n = {
    ...
    g = { ":TSymbols<cr>", "treesitter symbol in side panel" },
    h = { ":LspSymbols<cr>", "Symbols LSP" },
    j = { ":NRefPanel<cr>", "show symbol reference in side panel" },
    k = { ":LspKeymaps<cr>", "LSP Keymaps" },
    l = { ":Caltree", "lsp call hierarchy call tree, args: -i (incomming default), -o (outgoing)" },
  },
  o = {
    name = "Others",
